...
func main() {
	...
	convInt1, _ := strconv.ParseFloat(num1, 64) // Int calculation part. I didn't use conversion then " if num > 0 && num < 11 " as checker,
	convInt2, _ := strconv.ParseFloat(num2, 64) // cuz only 10 numbers are allowed, so I used a map instead.
